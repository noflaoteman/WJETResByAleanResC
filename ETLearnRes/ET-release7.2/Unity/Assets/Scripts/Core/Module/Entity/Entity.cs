    ...
    public partial class Entity : DisposeObject
    {
        ...
        public Entity Domain
        {
            ...
            private set
            {
                ...
                {
                    this.IsCreated = true;
                    EventSystem.Instance.DeserializeSystem(this);
                }
            }
        }
        ...
        public K GetComponent<K>() where K : Entity
        {
            ...
            {
                EventSystem.Instance.GetComponentSystem(this, component);
            }
        ...
        public Entity AddComponent(Entity component)
        {
            ...
            {
                EventSystem.Instance.AddComponentSystem(this, component);
            }
            return component;
        }
